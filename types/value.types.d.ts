...
export type AdaptiveCardFontSize = 'small' | 'default' | 'medium' | 'large' | 'extraLarge';
...
export type AdaptiveCardSpacing = 'default' | 'none' | 'small' | 'medium' | 'large' | 'extraLarge' | 'padding';
